...
switch (mes)
{
case 3: case 5: case 8: case 10: total_mes=30; break; case 1: 
total_mes=febrero; 
break; 
...
mes-=1;
// Al inicio agregamos +1 al mes, ya que contábamos los meses d 0-11,
...
//Verificado por: Gustavo Adolfo Chavarria Mercado
//UNAN-LEON Nicaragua
